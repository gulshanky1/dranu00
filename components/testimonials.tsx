...
const testimonials = [
  {
    name: 'Onnkar Shukla',
    location: 'Dubai, UAE',
    text: "Dr Anuradha possesses immense knowledge about astrology and she is very precise in predicting things. I have never come across such an astrologer who is so accurate. All her predictions came true and that too date wise. Highly recommend!",
    rating: 5,
    initials: 'OS',
  ...
  },
  {
    ...
    location: 'Dubai, UAE',
    text: "Dr Anuradha Rai is a wonderful person, an incredible astrologer and an accurate numerologist. Her perfect predictions starting from the past left me astonished as I had not told her anything beforehand.",
    rating: 5,
    initials: 'SK',
    color: 'from-teal-400 to-teal-600',
  },
  {
    name: 'Niharika Nigam',
    location: 'Dubai, UAE',
    text: "She is amazing. Not only is she an excellent astrologer, she has a healing aura of an Empath. The way she walks you through any doshas or issues in Kundali is a healing and rejuvenating process. Great predictions too.",
    rating: 5,
    initials: 'NN',
    color: 'from-orange-400 to-orange-600',
  },
  ...
  },
  {
    name: 'Timothy Ronin',
    location: 'Dubai, UAE',
    text: "I am a typical westerner with no experience of Vedic astrology. This is a highly educated woman with a PhD. She was very insightful and I was impressed by the depth of her knowledge and the accuracy of her readings.",
    rating: 5,
    initials: 'TR',
    color: 'from-orange-400 to-orange-600',
  },
  {
    name: 'Rakesh Anand',
    location: 'Dubai, UAE',
    text: "Dr. Anuradha is a thorough professional. Her predictions are accurate and she has profound knowledge and great insight about astrology. Her guidance has helped me tremendously.",
    rating: 5,
    initials: 'RA',
    color: 'from-teal-400 to-teal-600',
  },
  {
    name: 'Radhika Kalkunte',
    location: 'Dubai, UAE',
    text: "I am truly impressed the way you predicted things about my past, present and future. The remedies given and the way you cleared my doubts was amazing. Very good and deep knowledge about astrology.",
    rating: 5,
    initials: 'RK',
    color: 'from-orange-400 to-orange-600',
  },
  {
    name: 'Alex Poster',
    location: 'Dubai, UAE',
    text: "Dr. Rai is incredibly sweet, knowledgeable and answered all of my questions thoroughly. After meeting with her I have a renewed sense of clarity and motivation for the future.",
    rating: 5,
    initials: 'AP',
    color: 'from-teal-400 to-teal-600',
  },
  {
    name: 'travel win',
    location: 'Dubai, UAE',
    text: "I wanted to express my deepest gratitude for your guidance during a challenging period for my business. The remedies you suggested have truly worked wonders — our sales have increased significantly.",
    rating: 5,
    initials: 'TW',
    color: 'from-orange-400 to-orange-600',
  },
